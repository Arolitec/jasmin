...
class RouterPB(pb.Avatar):
    ...
    def addAmqpBroker(self, amqpBroker):
        ...
        yield self.amqpBroker.chan.exchange_declare(exchange='messaging', type='topic', durable=True)
        ...
        yield self.amqpBroker.chan.exchange_declare(exchange='billing', type='topic', durable=True)
